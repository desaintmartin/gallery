...
// Log Out
$I->click('#expandDisplayName');
$I->click('Log out');
$I->waitForText('Stay logged in');
...
$I->click($sharedFile1Label);
$I->moveMouseOver(null, -300, 0); // Should not be necessary but PhantomJS behaves strangely with mouse
$I->click($sharedFile2Label);
